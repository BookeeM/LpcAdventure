...
public class Joueur extends Sprite {
	...
	public enum State {
		FALLING, JUMPING, STANDING, RUNNING, DEAD, GAMEOVER
	};
	...
	public TextureRegion getFrame(float dt) {
		...
		case JUMPING:
			region = joueurIsBig ? (TextureRegion) bigFlamingoJump.getKeyFrame(stateTimer)
					: (TextureRegion) joueurJump.getKeyFrame(stateTimer);
			break;
		case RUNNING:
			region = joueurIsBig ? (TextureRegion) bigFlamingoRun.getKeyFrame(stateTimer, true)
					: (TextureRegion) joueurRun.getKeyFrame(stateTimer, true);
			break;
		case DEAD:
			region = joueurDead;
			break;
	...
	public void defineJoueur() {
		...
		fdef.filter.maskBits = LpcAdventure.GROUND_BIT | LpcAdventure.TROUSSE_BIT | LpcAdventure.BRICK_BIT
				| LpcAdventure.FIN_BIT | LpcAdventure.MOBS_BIT | LpcAdventure.OBJECT_BIT | LpcAdventure.MOBS_HEAD_BIT
				| LpcAdventure.ITEM_BIT;
