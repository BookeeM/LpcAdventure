...
public class Pingu extends Mobs {
	...
	protected void defineMob() {
		...
		fdef.filter.categoryBits = LpcAdventure.MOBS_PINGU_BIT;
		fdef.filter.maskBits = LpcAdventure.GROUND_BIT | LpcAdventure.MOBS_BIT | LpcAdventure.TROUSSE_BIT | LpcAdventure.BRICK_BIT | LpcAdventure.CYGNEBLOC_BIT | LpcAdventure.OBJECT_BIT | LpcAdventure.JOUEUR_BIT;
